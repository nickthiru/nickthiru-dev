...
<SEO
  title="Contact"
  description="How to reach Nick Thiru."
/>
      ...
      <div class="space-y-4 ml-4">
					<div>
						<a 
							...
							class="inline-flex items-center gap-2 text-primary dark:text-[#FAFAFA] hover:text-accent hover:no-underline"
						>
							...
							<svg class="w-4 h-4 opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
